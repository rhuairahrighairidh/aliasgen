...
// "Code generated" comment matches regex specified by in `go help generate`
// There's a gap before the package to avoid godoc thinking it's the doc comment.
const aliasTemplate = `// Code generated by aliasgen tool (github.com/rhuairahrighairidh/aliasgen) DO NOT EDIT.
